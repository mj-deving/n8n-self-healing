...
```bash
npx --yes n8nac push /home/USER/projects/n8n-self-healing/workflows/agents/self-healer/workflow/workflow.ts
npx --yes n8nac push /home/USER/projects/n8n-self-healing/workflows/pipelines/api-data-sync/workflow/workflow.ts
npx --yes n8nac push /home/USER/projects/n8n-self-healing/workflows/utilities/error-simulator/workflow/workflow.ts
```
