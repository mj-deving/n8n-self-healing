...
```bash
npx --yes n8nac push /home/USER/projects/n8n-self-healing/workflows/agents/self-healer/workflow/workflow.ts --verify
npx --yes n8nac push /home/USER/projects/n8n-self-healing/workflows/pipelines/api-data-sync/workflow/workflow.ts --verify
npx --yes n8nac push /home/USER/projects/n8n-self-healing/workflows/utilities/error-simulator/workflow/workflow.ts --verify
```
...
```bash
cd /home/USER/projects/n8n-self-healing/.beads/embeddeddolt/n8n_self_healing
dolt branch -vv
```
